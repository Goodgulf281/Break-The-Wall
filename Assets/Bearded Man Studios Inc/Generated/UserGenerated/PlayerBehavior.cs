...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	[GeneratedRPCVariableNames("{\"types\":[[\"position\", \"playerID\"]]")]
	public abstract partial class PlayerBehavior : NetworkBehavior
	{
		public const byte RPC_CREATE_PROJECTILE = 0 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("CreateProjectile", CreateProjectile, typeof(Vector3), typeof(int));
		...
		/// int playerID
		/// </summary>
		public abstract void CreateProjectile(RpcArgs args);
