...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class AimNetworkObject : NetworkObject
	{
		...
		public AimNetworkObject() : base() { Initialize(); }
		public AimNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public AimNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
