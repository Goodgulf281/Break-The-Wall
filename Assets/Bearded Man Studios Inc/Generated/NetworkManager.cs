...
namespace BeardedManStudios.Forge.Networking.Unity
{
	public partial class NetworkManager : MonoBehaviour
	{
		...
		private void CaptureObjects(NetworkObject obj)
		{
			...
			if (obj is AimNetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					...
					{
						if (AimNetworkObject.Length > 0 && AimNetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(AimNetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<AimBehavior>();
						}
					}
			...
			else if (obj is CubeNetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					NetworkBehavior newObj = null;
					if (!NetworkBehavior.skipAttachIds.TryGetValue(obj.NetworkId, out newObj))
					{
						if (CubeNetworkObject.Length > 0 && CubeNetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(CubeNetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<CubeBehavior>();
						}
					}
		...
		[Obsolete("Use InstantiateAim instead, its shorter and easier to type out ;)")]
		public AimBehavior InstantiateAimNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(AimNetworkObject[index]);
			var netBehavior = go.GetComponent<AimBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
			go.GetComponent<AimBehavior>().networkObject = (AimNetworkObject)obj;
		...
		[Obsolete("Use InstantiateCube instead, its shorter and easier to type out ;)")]
		public CubeBehavior InstantiateCubeNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(CubeNetworkObject[index]);
			var netBehavior = go.GetComponent<CubeBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
			go.GetComponent<CubeBehavior>().networkObject = (CubeNetworkObject)obj;
		...
		/// <summary>
		/// Instantiate an instance of Aim
		/// </summary>
		/// <returns>
		/// A local instance of AimBehavior
		/// </returns>
		/// <param name="index">The index of the Aim prefab in the NetworkManager to Instantiate</param>
		/// <param name="position">Optional parameter which defines the position of the created GameObject</param>
		/// <param name="rotation">Optional parameter which defines the rotation of the created GameObject</param>
		/// <param name="sendTransform">Optional Parameter to send transform data to other connected clients on Instantiation</param>
		public AimBehavior InstantiateAim(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(AimNetworkObject[index]);
			var netBehavior = go.GetComponent<AimBehavior>();
		...
		/// <summary>
		/// Instantiate an instance of Cube
		/// </summary>
		/// <returns>
		/// A local instance of CubeBehavior
		/// </returns>
		/// <param name="index">The index of the Cube prefab in the NetworkManager to Instantiate</param>
		/// <param name="position">Optional parameter which defines the position of the created GameObject</param>
		/// <param name="rotation">Optional parameter which defines the rotation of the created GameObject</param>
		/// <param name="sendTransform">Optional Parameter to send transform data to other connected clients on Instantiation</param>
		public CubeBehavior InstantiateCube(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(CubeNetworkObject[index]);
			var netBehavior = go.GetComponent<CubeBehavior>();
